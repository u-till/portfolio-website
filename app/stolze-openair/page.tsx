...
const VIDEO_ID = 'nwVeRbBd_hQ';

export default function StolzeOpenairPage() {
  ...
  return (
    <section className='text-white'>
      ...
      <div className='h-screen relative overflow-hidden'>
        <iframe
          ref={iframeRef}
          src={`https://www.youtube-nocookie.com/embed/${VIDEO_ID}?autoplay=1&mute=1&loop=1&playlist=${VIDEO_ID}&controls=0&start=1&playsinline=1&rel=0&enablejsapi=1`}
        ...
        <div className='flex flex-col gap-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-5 gap-y-2 text-base'>
              ...
              <div className='md:col-span-2'>
                <p className='leading-relaxed'>
                  ...
                  committee since 2018. Involved in booking music acts, construction of the festival, and taking care of
                  the website and everything digital.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className='grid grid-cols-2 md:grid-cols-5 gap-y-2 text-base'>
              <div className='hidden md:block'></div>
              <div className='font-bold md:text-right'>Video</div>
              <div className='hidden md:block'></div>
              <div className='md:col-span-2'>
                <a
                  href='https://farbfilm.ch'
                  target='_blank'
                  rel='noopener noreferrer'
                  className='underline hover:no-underline'
                >
